...
\begin{center}
\subfloat[]{
\includegraphics[width=\textwidth/2-2cm]{figs/graphs/update_times_full.png}
}
\subfloat[]{
\includegraphics[width=\textwidth/2-2cm]{figs/graphs/update_times_cut30.png}
}
\end{center}
\caption{Plot and detail of the time taken for {\ttfamily update-answer} to complete, over the course of one session.}
\end{figure}
\end{center}
