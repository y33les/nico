...
mathematical problems to solve using the notation.  The motivation behind
developing a new notation rather than using the normal means of writing down
calculations was
