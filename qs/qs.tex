...
The purpose of this research is to assess the usability of a graphical notation
and software application for representing mathematical calculations in a
graphical manner.\\

The study involves the use of the application whilst being supervised.  I will
be asked to complete certain tasks both with and without the application, and
I will also be asked open-ended questions about the application and my experience
as a user thereof.\\

All information collected in the study is confidential, and my name will not
be identified at any time.  I understand that I may ask questions or terminate
my involvement in the study freely and at any time without consequence.\\
...
\vfill
\begin{center}
{\bf THIS PAGE INTENTIONALLY LEFT BLANK}
\end{center}
\vfill
\pagebreak
