...
Learning the Clojure programming language. % TODO: expand
...
accompanying application to act as a learning aid for pre-algebra arithmetic in schools.  Using Petre and Green's `Cognitive Dimensions' framework, the project aims to increase the \emph{visibility} of the notation, reduce the number of \emph{hidden dependencies} between units of notation and make the flow of data obvious to the user. \cite{Green1996}  I have successfully developed such a system,
...
calculations according to the `Cognitive Dimensions'
framework cited above, and a discussion of the properties that a useful
...
With regard to the representation and processing of calculations, a framework in which calculations are easy to store and manipulate, and in which evaluation can be delayed, would be advantageous. % TODO: this bit, wtf
...
There is a niche for a tool for use in education that represents calculations in a visual manner, with a particular focus on making the method by which arithmetic problems are solved clear.  This project aims to provide an environment in which the user can explore the many ways in which a problem can be solved using a novel graphical notation. % TODO: emphasise? wtf
...
% TODO: not happy with this; not sure it counts as an overview
