...
became the basis for the rest of the project.
...
numbers.  As the target audience is not yet requierd to have formally learnt
(or, indeed, encountered) algebra, this notation uses line numbers to refer to
the results of the calculation performed on that line.
