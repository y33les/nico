...
some time developing the back-end, I began work on the user interface.  I
...
question into one circle that will complete the calculation for them.  To use
...
Colour-coding is also used in the information panels at the top of the
application: positioning the mouse cursor over a circle highlights the part of
