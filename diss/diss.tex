...
of the form \verb¬{:x ¬\emph{x}verb¬ :y ¬\emph{y}\verb¬ :name ¬\emph{s}\verb¬ :circ ¬\emph{l}\verb¬}¬, where \emph{x} and \emph{y} are integers representative of the circle's
co-ordinates on the canvas, \emph{s} is a string used to refer to
the circle and the \emph{l} is an S-expression representative of the
...
been to include either as part of the rendering loop or as part of \verb¬del-circle-safe¬ a function to inspect
