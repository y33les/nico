...
To develop a piece of educational software in the Clojure programming language
that allows the user to express a series of mathematical calculations in a
graphical manner, making the method by which the answer was reached clear
